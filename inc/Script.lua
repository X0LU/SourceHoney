...
if redis:get(max.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		ali = {'فدييت','لا قيمه للقمر امامك','نتيكن؟','وربنا مزز','حبيييت','اطلق من يكتب ايدي','يلبيه',' عسل صلاتي على النبي ','جببر❤️','يعمري😍','مارتاحلك خيو','تحبني؟',
		}
...
return '👨🏾‍🔧│ اصدار سورس عسل : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس 🔂') then
if not msg.SudoBase then return "♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local GetVerison = https.request('https://github.com/X0LU/SourceHoney.github.io/GetVersion.txt') or 0
...
local inline = {{{text="⚜│قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/@SourceHoney"}}}
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : عسل](t.me/@SourceHoney)',nil,inline,msg.id_)
return false
end
...
👋│اهلا بك في سورس عسل
●ـ▬ـ▬ஜ۩۞۩ஜ▬ـ▬ـ●
📡╿[قناة السورس](t.me/SourceHoney)
🤖│[بوت تواصل](t.me/X000Lbot)
👨🏻‍✈️╽[مطور السـورس](t.me/X000L)
●ـ▬ــ▬ஜ۩۞۩ஜ▬ـ▬ـ●
...
"كفايه قبل شويه سلمت😌",
"منور",
"هلا لاهنت اذا عندك قروبات ضيفني وارفعني مشرف🤷🏼‍♀️❤️",
"هاي ولا جبر؟",
"هلو ولا جبر؟",
"اطلق هاي عمري",
}
...
" نورت مطوري 😍",
"هلا بأطلق مطور 😍 ",
"هلا حبيبي ["..Bot_Name.."] 😘❤️",
}
local sss = {
"ماشي الحال",
"تمام وانت يقلبي ؟ 💕",
"تمام بشوفتك❤️",
"ع الله مافي شيء جديد",
}
local dr = {
"الله وياك",
"انتبهلك يقلبي",
...
if msg.reply_id then
sendMsg(msg.chat_id_,msg.id_,'عيب')
sendMsg(msg.chat_id_,msg.reply_id,'قلت لك عيب') 
else
end
...
return sendMsg(msg.chat_id_,msg.id_,"📌 هممح")
end 
...
return sendMsg(msg.chat_id_,msg.id_,"هكثر❤️")
elseif msg.SudoUser and Text== "تحبني" or Text=="حبك" then 
return sendMsg(msg.chat_id_,msg.id_,"اعشقك❤️")
...
if msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,'عيب ارتقي')
else 
return sendMsg(msg.chat_id_,msg.id_,"📌 ودي بس الهواء ضدي") 
end
elseif Text== "تف" then return sendMsg(msg.chat_id_,msg.id_,"عيب يبني")
elseif Text== "احمد سلطان" then return sendMsg(msg.chat_id_,msg.id_,"[ مطور سورس عسل](t.me/X000L")
elseif Text== "تمام" then return sendMsg(msg.chat_id_,msg.id_,"دوم يقلبي")
elseif Text== "وينك"  then return sendMsg(msg.chat_id_,msg.id_,"بقلبك❤️.")
elseif Text== "منورين"  then return sendMsg(msg.chat_id_,msg.id_,"من نورك يقلبي ❤️")
elseif Text== "هاي"  then return sendMsg(msg.chat_id_,msg.id_,"هاي ولا جبر؟")
elseif Text== "منور"  then return sendMsg(msg.chat_id_,msg.id_,"نورك يبعدي")
elseif Text== "شكرا" or Text== "ثكرا" then return  sendMsg(msg.chat_id_,msg.id_,"الــعـفو ")
elseif Text== "اكرهك"  then return sendMsg(msg.chat_id_,msg.id_,"محد يهتم")
elseif Text== "اجيت" or Text=="اني اجيت" then return  sendMsg(msg.chat_id_,msg.id_,"اطلق من يجي❤️")
...
elseif Text== "كلخرا" or Text== "اكل خره" then return sendMsg(msg.chat_id_,msg.id_,"اخلاقك ماش")
elseif Text== "خاصك"  then return sendMsg(msg.chat_id_,msg.id_,"عادي اجي؟💜")
elseif Text== "احبج"  then return sendMsg(msg.chat_id_,msg.id_,"يخي احترم شعور السنقل 😢")
elseif Text== "مرحبا"  then return sendMsg(msg.chat_id_,msg.id_,"مرحبا ولا جبر؟")
elseif Text== "سلام" or Text== "السلام عليكم" or Text== "سلام عليكم" or Text=="سلامن عليكم" or Text=="السلامن عليكم" then 
return sendMsg(msg.chat_id_,msg.id_,"وعليكم السلام ورحمه الله وبركاته" )
elseif Text== "عضه"  then return sendMsg(msg.chat_id_,msg.id_,"قالو لك كلب؟ انته روح عضه 😕" )
elseif Text== "شغال"  then return sendMsg(msg.chat_id_,msg.id_,"تشوف؟")
elseif Text== "تخليني"  then return sendMsg(msg.chat_id_,msg.id_,"اخليك بزاويه 380 درجه وانته تعرف الباقي :)")
elseif Text== "فديتك" or Text== "فديتنك"  then return  sendMsg(msg.chat_id_,msg.id_,"فداك الكون يقلبي" )
elseif Text== "مساعدة"  then return sendMsg(msg.chat_id_,msg.id_,"لعرض قائمة المساعدة اكتب الاوامر ❤️")
elseif Text== "حلو"  then return sendMsg(msg.chat_id_,msg.id_,"حرام طلاق انت الحلو❤️")
elseif Text== "حبيبي" or Text=="حبي" then return  sendMsg(msg.chat_id_,msg.id_,"بعد روحي❤️ امرني")
elseif Text== "حبيبتي" then return sendMsg(msg.chat_id_,msg.id_,"مين هيا قول؟")
elseif Text== "حياتي" then return sendMsg(msg.chat_id_,msg.id_,"عيونه")
elseif Text== "عمري" then return sendMsg(msg.chat_id_,msg.id_,"هلا قلبي ")
elseif Text== "اسكت" then return sendMsg(msg.chat_id_,msg.id_,"ابشر")
elseif Text== "بتحبني" then return sendMsg(msg.chat_id_,msg.id_,"بحبك اد مجرة درب تبانة")
elseif Text== "المعزوفه" or Text=="المعزوفة" or Text=="معزوفه" then 
return sendMsg(msg.chat_id_,msg.id_,"رح اطلب الله بس")
elseif Text== "موجود" then return sendMsg(msg.chat_id_,msg.id_,"تفضل عزيزي")
elseif Text== "اقلك" then return sendMsg(msg.chat_id_,msg.id_,".قول وش تنتظر؟")
elseif Text== "اشكرك" then return sendMsg(msg.chat_id_,msg.id_,"بخدمتكم دائماً ❤")
elseif Text== "اطردني"  then return sendMsg(msg.chat_id_,msg.id_,"تحب المذله")
elseif Text== "رفع ثور"  then return sendMsg(msg.chat_id_,msg.id_,"🙋🏻‍♂╿اهــلا عزيزي\n🎫│تم رفع العضو ثور القروب بنجاح✔️\n🛠╽تمت إضافته إلى قائمه الثيران\n✓️")
elseif Text== "تنزيل ثور"  then return sendMsg(msg.chat_id_,msg.id_,"🙋🏻‍♂╿اهــلا عزيزي\n🎫│تم تنزيل العضو من ثيران القروب✔️\n🛠╽تمت الزاله من قامة الثيران\n✓️")
...
elseif Text== "رفع تيس"  then return sendMsg(msg.chat_id_,msg.id_,"🙋🏻‍♂╿اهــلا عزيزي\n🎫│تم رفع المتهم تيس بنجاح✔️\n🛠╽الان اصبح تيس الكروب 🐐\n✓️")
elseif Text== "تنزيل تيس"  then return sendMsg(msg.chat_id_,msg.id_,"🙋🏻‍♂╿اهــلا عزيزي\n🎫│تم تنزيل المتهم تيس بنجاح✔️\n🛠╽تمت ٳزالته من قائمة التيوس🐐\n✓️")
...
return sendMsg(msg.chat_id_,msg.id_,"للهم من اعتز بك فلن يذل .. ومن اهتدى بك فلن يضل .. ومن استكثر بك فلن يقل .. ومن استقوى بك فلن يضعف .. ومن استغنى بك فلن يفتقر .. ومن استنصر بك فلن يخذل .. ومن استعان بك فلن يغلب .. ومن توكل عليك فلن يخيب .. ومن جعلك ملاذه فلن يضيع .. ومن اعتصم بك فقد هدي إلى صراط مستقيم .. اللهم فكن لنا وليا ونصيرا ً... وكن لنا معينا ومجيرا .. إنك كنت بنا بصير")
...
return sendMsg(msg.chat_id_,msg.id_,"مين رفعك؟")
else 
