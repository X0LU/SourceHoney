...
if not msg.SudoBase then return "♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local GetVerison = https.request('https://max.github.io/GetVersion.txt') or 0
...
sendMsg(msg.chat_id_,msg.id_,'📛*│* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس عسل يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n💥')
end  
else
...
sendMsg(msg.chat_id_,msg.reply_id,'الله يهديك') 
else
end
...
elseif Text== "تف" then return sendMsg(msg.chat_id_,msg.id_,"عيب خيو")
elseif Text== "احمد" then return sendMsg(msg.chat_id_,msg.id_,"[صاحب السورس](t.me/X000L")
elseif Text== "احمد سلطان" then return sendMsg(msg.chat_id_,msg.id_,"[ مطور سورس عسل](t.me/X000L")
elseif Text== "تمام" then return sendMsg(msg.chat_id_,msg.id_,"دوم")
elseif Text== "وينك"  then return sendMsg(msg.chat_id_,msg.id_,"بقلبك❤️.")
elseif Text== "منورين"  then return sendMsg(msg.chat_id_,msg.id_,"نورك ذا ي بعد قلبي")
elseif Text== "هاي"  then return sendMsg(msg.chat_id_,msg.id_,"هاي ولا جبر؟")
elseif Text== "منور"  then return sendMsg(msg.chat_id_,msg.id_,"نورك ذا ي حياتي")
elseif Text== "😒" and not is_sudo then return sendMsg(msg.chat_id_,msg.id_,"مين مزعلك خيو")
elseif Text== "مح"  then return sendMsg(msg.chat_id_,msg.id_,"فديت البوسه❤")
elseif Text== "شكرا" or Text== "ثكرا" then return  sendMsg(msg.chat_id_,msg.id_,"{ العفو  }")
elseif Text== "اكرهك"  then return sendMsg(msg.chat_id_,msg.id_,"احس اني متضايق")
...
elseif Text== "كلخرا" or Text== "اكل خره" then return sendMsg(msg.chat_id_,msg.id_,"عيب")
elseif Text== "😔"  then return sendMsg(msg.chat_id_,msg.id_,"ليش الحلو زعلان❤️")
elseif Text== "☹️"  then return sendMsg(msg.chat_id_,msg.id_,"شفيك يقلبي❤️.")
elseif Text== "جوعان"  then return sendMsg(msg.chat_id_,msg.id_,"قم سوي لك اكل")
...
elseif Text== "متضايق"  then return sendMsg(msg.chat_id_,msg.id_,"ليش متضايق حياتي")
elseif Text== "متضايقه"  then return sendMsg(msg.chat_id_,msg.id_,"منو مضايقك يقلبي")
...
elseif Text== "فديتك" or Text== "فديتنك"  then return  sendMsg(msg.chat_id_,msg.id_,"فداك/ي مجرة درب تبانة" )
elseif Text== "مساعدة"  then return sendMsg(msg.chat_id_,msg.id_,"لعرض قائمة المساعدة اكتب الاوامر❤️.")
elseif Text== "حلو"  then return sendMsg(msg.chat_id_,msg.id_,"انت الحلو يقلبي❤️")
elseif Text== "شسمك"  then return sendMsg(msg.chat_id_,msg.id_,"⚜╿أسمي ["..Bot_Name.."]\n👨🏻‍✈️│آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت\n📛│مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...\n⚠️╽ضيفني لقروبك ورفعني مشرف بلقروب وارسل تفعيل داخل القروب")
elseif Text== "اسكت" then return sendMsg(msg.chat_id_,msg.id_,"يواد قوم يواد")
elseif Text== "اشكرك" then return sendMsg(msg.chat_id_,msg.id_,"بخدمتك حبي ❤")
elseif Text== "اطردني"  then return sendMsg(msg.chat_id_,msg.id_,"ليه تحب المذله؟")
...
return sendMsg(msg.chat_id_,msg.id_,"اللهم من اعتز بك فلن يذل .. ومن اهتدى بك فلن يضل .. ومن استكثر بك فلن يقل .. ومن استقوى بك فلن يضعف .. ومن استغنى بك فلن يفتقر .. ومن استنصر بك فلن يخذل .. ومن استعان بك فلن يغلب .. ومن توكل عليك فلن يخيب .. ومن جعلك ملاذه فلن يضيع .. ومن اعتصم بك فقد هدي إلى صراط مستقيم .. اللهم فكن لنا وليا ونصيرا ً... وكن لنا معينا ومجيرا .. إنك كنت بنا بصيرا ..")
...
♦️│فكر اكثر في موضوع يقلبي قبل تحذف  
🚸│[اضغط هنا لـحـذف الـحـسـاب](https://telegram.org/deactivate)
👨🏽‍⚖️│بالتـوفيـق عزيزي ...
🎁╽[اضغط هنا لديك مفاجئه](https://t.me/X000L)
]] )
--=====================================
