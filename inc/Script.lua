...
function download_to_file(url, file_name)
    ...
    local inline = {{{text="قناة السورس .",url="t.me/@SourceHoney"}}}
    send_key(msg.sender_user_id_,'[ قناة سورس dreem .](t.me/@SourceHoney)',nil,inline,msg.id_)
    return false
    end
    ...
    return [[
      ⋆ مطـور السورس  ⇽  [أحمد سلطان](http://t.me/X000L)
    ⋆ مطـور السورس  ⇽  [ناز(t.me/IIJJU)
    ⋆ قناة السورس   ⇽  [Honey](t.me/SourceHoney)
    ⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆⋆ ⋆ ⋆ ⋆ ⋆
    ⠀⠀
    ]]
    end
    ...
    local su = {
      ...
      sendMsg(msg.chat_id_,msg.reply_id,'عيب يبني') 
      else
      end
      elseif Text:match("^"..Bot_Name.." بوت(.*)$") and msg.SudoUser then
      if msg.reply_id then
      sendMsg(msg.chat_id_,msg.id_,' ??')
      return sendMsg(msg.chat_id_,msg.reply_id,'عصب عصب') 
      end
      ...
      elseif Text== "مالك السورس" then return sendMsg(msg.chat_id_,msg.id_,"[⇽ AHMED SULTAN](t.me/X000L")
      elseif Text== "مطور السورس" then return sendMsg(msg.chat_id_,msg.id_,"[⇽ AHMED SULTAN](t.me/X000L")
      elseif Text== "AHMED SULTAN" then return sendMsg(msg.chat_id_,msg.id_,"[مطـور سورس عسل](t.me/X000L")
      elseif Text== "ناز" then return sendMsg(msg.chat_id_,msg.id_,"[مطـور سورس عسل](t.me/IIJJU")
    ...
    [بنشتاق لك .](https://telegram.org/deactivate)
    ]] )
    --=====================================
